...
export const Tab: React.FC<TabProps> = ({ task, initialLanguage = "python", onComplete }) => {
  ...
  const content = (
    <div className="flex flex-col md:flex-row gap-6 p-6 bg-card rounded-2xl shadow-xl transition-all duration-300 w-full border border-border">
      ...
      <div className="w-full md:w-[340px] max-w-[400px] flex flex-col gap-4">
        <div>
          ...
          <ShadTextarea
            ...
            className="w-full min-h-[80px] font-mono bg-background border border-border text-sm px-3 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-ring resize-y"
            style={{ fontFamily: "var(--font-jetbrains-mono)" }}
