    ...
    <div className="min-h-screen flex flex-col bg-black transition-colors duration-200">
      ...
      <div className="flex-1">
        <section className="relative w-full min-h-[80vh] sm:aspect-video pt-12 sm:pt-16 pb-8 sm:pb-12 px-4 sm:px-6 lg:px-8 overflow-hidden">
          ...
          <div className="absolute top-1/4 left-1/4 w-48 sm:w-64 h-48 sm:h-64 bg-blue-500/20 rounded-full mix-blend-multiply filter blur-2xl animate-blob" />
          <div className="absolute top-1/3 right-1/4 w-48 sm:w-64 h-48 sm:h-64 bg-cyan-500/20 rounded-full mix-blend-multiply filter blur-2xl animate-blob animation-delay-2000" />
          <div className="absolute bottom-1/4 left-1/3 w-48 sm:w-64 h-48 sm:h-64 bg-blue-400/20 rounded-full mix-blend-multiply filter blur-2xl animate-blob animation-delay-4000" />

          <div className="relative h-full max-w-5xl mx-auto flex flex-col justify-center">
            <div className="text-center">
              <div className="inline-flex items-center px-3 sm:px-4 py-1 sm:py-1.5 rounded-full bg-gradient-to-r from-blue-500 to-cyan-500 text-white text-xs sm:text-sm font-medium mb-4 sm:mb-6 shadow-sm">
                <span className="mr-1.5 sm:mr-2">✨</span> Now with compilers! 
              </div>

              <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight mb-3 sm:mb-4 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-cyan-400 to-blue-400">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4 sm:px-0">
                <a
                  href="/explore"
                  className="group inline-flex items-center justify-center px-4 sm:px-6 py-2 sm:py-2.5 rounded-lg bg-gradient-to-r from-blue-600 to-cyan-600 text-white text-sm sm:text-base font-medium hover:from-blue-700 hover:to-cyan-700 transition-all duration-200 shadow-sm hover:shadow"
                >
                  Start Learning
                ...
                <a
                  href="/demo"
                  className="group inline-flex items-center justify-center px-4 sm:px-6 py-2 sm:py-2.5 rounded-lg border border-blue-700 text-gray-300 text-sm sm:text-base font-medium hover:bg-blue-900/20 transition-all duration-200"
                >
                  Watch Demo
                  <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 ml-1.5 sm:ml-2 group-hover:translate-x-0.5 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="mt-8 sm:mt-10 flex flex-wrap justify-center gap-4 sm:gap-6 items-center text-xs sm:text-sm text-gray-400 px-4 sm:px-0">
                <div className="flex items-center">
                  <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 mr-1.5 sm:mr-2 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <section className="py-12 sm:py-16 px-4 sm:px-6 lg:px-8 bg-black">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
              <div className="group bg-gray-900 p-4 sm:p-6 rounded-xl shadow-sm border border-blue-700 hover:shadow transition-all duration-200">
                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-lg flex items-center justify-center mb-3 sm:mb-4 text-white">
                ...
                <div className="mt-3 sm:mt-4 flex items-center text-blue-400 font-medium text-sm group-hover:translate-x-1 transition-transform">
                  Learn more
        ...
        <section className="py-12 sm:py-16 px-4 sm:px-6 lg:px-8 bg-black">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
              <div className="text-center p-3 sm:p-5 rounded-lg bg-gray-900 border border-blue-700 hover:shadow transition-all duration-200">
                <div className="text-2xl sm:text-3xl font-bold text-white mb-1 sm:mb-2 bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">500+</div>
                <div className="text-xs sm:text-sm text-gray-300">Active NIS Students</div>
              </div>
              <div className="text-center p-3 sm:p-5 rounded-lg bg-gray-900 border border-blue-700 hover:shadow transition-all duration-200">
                <div className="text-2xl sm:text-3xl font-bold text-white mb-1 sm:mb-2 bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">95%</div>
                <div className="text-xs sm:text-sm text-gray-300">Exam Success Rate</div>
              </div>
              <div className="text-center p-3 sm:p-5 rounded-lg bg-gray-900 border border-blue-700 hover:shadow transition-all duration-200">
                <div className="text-2xl sm:text-3xl font-bold text-white mb-1 sm:mb-2 bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">20+</div>
                <div className="text-xs sm:text-sm text-gray-300">NIS Schools</div>
              </div>
              <div className="text-center p-3 sm:p-5 rounded-lg bg-gray-900 border border-blue-700 hover:shadow transition-all duration-200">
                <div className="text-2xl sm:text-3xl font-bold text-white mb-1 sm:mb-2 bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">4.8/5</div>
